...
\begin{theorem}[幂级数的条件收敛]
    \index{幂级数的条件收敛}
    若幂级数 $ \displaystyle \sum_{n=1}^{\infty} a_nx^n $ 在 $x=b$ 处条件收敛, 则 $x=b$ 为该幂级数收敛区间的一个端点, 且收敛半径 $R=|b|$, 收敛区间为 $(-|b|,|b|)$.
\end{theorem}

\begin{example}
    设幂级数 $\displaystyle \sum_{n=0}^{\infty} a_n(x-2)^n$ 在 $x=-2$ 处条件收敛, $a_n>0,~n=0, 1, 2, \cdots $, 则 $\displaystyle \sum_{n=0}^{\infty} a_n(x-2)^{2n+1}$ 的收敛域为 (\quad).
    \begin{tasks}(4)
        \task $(1,3)$
        \task $(0,4)$
        \task $[-2,2)$
...
\begin{example}
    设 $ \displaystyle \sum_{n=0}^{\infty} a_nx^n $ 在 $x=3$ 处条件收敛, 则 $ \displaystyle \sum_{n=0}^{\infty} \dfrac{a_n}{n+1}(x-1)^n $ 在 $x=-1$ 处 (\quad).
    \begin{tasks}(4)
        \task 条件收敛
        \task 绝对收敛
        \task 发散
...
\begin{example}[2020 数三]
    设幂级数 $\displaystyle\sum_{n=1}^{\infty}na_n(x-2)^n$ 的收敛区间为 $(-2,6)$, 则 $\displaystyle\sum_{n=1}^{\infty}a_n(x+1)^{2n}$ 的收敛区间为 (\quad).
    \begin{tasks}(4)
        \task $(-2,6)$
        \task $(-3,1)$
        \task $(-5,3)$
...
\end{example}
\begin{solution}
    因为 $\displaystyle \sum_{n=0}^{\infty}(-1)^{n}\dfrac{x^{n+1}}{n+1}=\ln(1+x)$, 所以有
...
\begin{solution}
    ...
    其中
    \begin{flalign*}
        S_1(x) & =\sum_{n=0}^{\infty} \dfrac{1}{n!}(x-1)^{n+2}=(x-1)^2\sum_{n=0}^{\infty} \dfrac{(x-1)^n}{n!}=(x-1)^2\e ^{x-1}                               \\
        S_3(x) & =\dfrac{1}{x-1}\sum_{n=0}^{\infty}\dfrac{(x-1)^{n+1}}{(n+1)!}=\dfrac{1}{x-1}\sum_{n=1}^{\infty}\dfrac{(x-1)^n}{n!}=\dfrac{\e ^{x-1}-1}{x-1}
    \end{flalign*}
...
\begin{solution}
    令 $x=\cos\theta$, 那么
    \begin{flalign*}
        \int_{0}^{1}\qty(1-x^2)^nx^3\dd x & =\int_{0}^{\frac{\pi}{2}}\sin^{2n+1}\theta\cos^3\theta\dd \theta=\int_{0}^{\frac{\pi}{2}}\qty(\sin^{2n+1}\theta-\sin^{2n+3}\theta)\dd \sin\theta \\
                                          & =\dfrac{1}{2}\qty(\dfrac{1}{n+1}-\dfrac{1}{n+2})
    \end{flalign*}
...
\begin{solution}
    \begin{enumerate}[label=(\arabic{*})]
        ...
        \item 令 $t=2-x$, 则
              \begin{flalign*}
                  I=-\int_{1}^{2} \dfrac{\ln(2-t)}{t} \dd t=-\int_{1}^{2} \dfrac{\ln 2+\ln\qty(1-\dfrac{t}{2})}{t} \dd t=-\ln^2 2-\int_{1}^{2} \dfrac{1}{t}\ln\qty(1-\dfrac{t}{2}) \dd t
              \end{flalign*}
              下求 $\displaystyle \int_{1}^{2} \dfrac{1}{t}\ln\qty(1-\dfrac{t}{2}) \dd t$,
              \begin{flalign*}
                  \int_{1}^{2} \dfrac{1}{t}\ln\qty(1-\dfrac{t}{2}) \dd t & =-\int_{1}^{2} \sum_{n=1}^{\infty} \dfrac{t^{n-1}}{n\cdot 2^{n}} \dd t=-\sum_{n=1}^{\infty} \int_{1}^{2} \dfrac{t^{n-1}}{n\cdot 2^{n}} \dd t=\sum_{n=1}^{\infty} \qty(\dfrac{1}{n^2\cdot2^n}-\dfrac{1}{n^2}) \\
                                                                         & =\sum_{n=1}^{\infty} \dfrac{1}{n^2\cdot 2^n}-\sum_{n=1}^{\infty} \dfrac{1}{n^2}=\dfrac{\pi^2}{12}-\dfrac{\ln^2 2}{2}-\dfrac{\pi^2}{6}
              \end{flalign*}
