...
%Shape: Parallelogram [id:dp15094409224905658] 
\draw   (49.55,43.38) -- (193.04,43.38) -- (157.33,96.15) -- (13.84,96.15) -- cycle ;
%Straight Lines [id:da6743410604742572] 
\draw    (131.04,8.98) -- (131,66.4) ;
\draw [shift={(131,66.4)}, rotate = 90.04] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 1.34, y radius= 1.34]   ;
\draw [shift={(131.04,8.98)}, rotate = 90.04] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 1.34, y radius= 1.34]   ;
%Straight Lines [id:da35640813358813483] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (131,66.4) -- (130.96,123.82) ;
\draw [shift={(130.96,123.82)}, rotate = 90.04] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 1.34, y radius= 1.34]   ;
\draw [shift={(131,66.4)}, rotate = 90.04] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 1.34, y radius= 1.34]   ;
%Straight Lines [id:da5052036786462526] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (83.84,66.66) -- (130.96,123.82) ;
%Straight Lines [id:da6835962397357249] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (83.84,66.66) -- (131,66.4) ;
\draw [shift={(83.84,66.66)}, rotate = 359.68] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 1.34, y radius= 1.34]   ;
%Straight Lines [id:da9804195552709265] 
\draw    (36.72,9.51) -- (83.84,66.66) ;
\draw [shift={(36.72,9.51)}, rotate = 50.5] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 1.34, y radius= 1.34]   ;
%Straight Lines [id:da5537688902051754] 
\draw    (83.84,66.66) -- (131.04,8.98) ;

% Text Node
\draw (29.75,85.87) node   [align=left] {\begin{minipage}[lt]{9.72pt}\setlength\topsep{0pt}
$\displaystyle \Pi $
\end{minipage}};
% Text Node
\draw (141.32,10.33) node   [align=left] {\begin{minipage}[lt]{12.13pt}\setlength\topsep{0pt}
$\displaystyle P$
\end{minipage}};
% Text Node
\draw (141.72,70.8) node   [align=left] {\begin{minipage}[lt]{12.13pt}\setlength\topsep{0pt}
$\displaystyle P_{0}$
\end{minipage}};
% Text Node
\draw (140.12,128) node   [align=left] {\begin{minipage}[lt]{12.13pt}\setlength\topsep{0pt}
$\displaystyle P'$
\end{minipage}};
% Text Node
\draw (76.12,77.6) node   [align=left] {\begin{minipage}[lt]{12.13pt}\setlength\topsep{0pt}
$\displaystyle M$
\end{minipage}};
% Text Node
\draw (25.32,20.8) node   [align=left] {\begin{minipage}[lt]{12.13pt}\setlength\topsep{0pt}
$\displaystyle Q$
\end{minipage}};
