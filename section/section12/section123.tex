...
\begin{solution}
    ...
    \begin{flalign*}
        ...
        \xrightarrow[r_1+r_3\substack{r_1+r_3\\r_2+r_3}]{\substack{r_3\times \frac{1}{5}\\ r_2\times \frac{1}{3}}}
        \begin{pmatrix} 1 & 0 & 0 & -7 & 3 \\ 0 & 1 & 0 & -\dfrac{7}{3} & \dfrac{2}{3} \\[6pt] 0 & 0 & 1 & -\dfrac{7}{5} & \dfrac{1}{5}\end{pmatrix}
    \end{flalign*}
