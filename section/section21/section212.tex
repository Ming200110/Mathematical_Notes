...
\begin{theorem}[$\sigma^{2} $ 已知时 $ \mu $ 的置信区间]
    ...
    得到 $ \mu $ 的置信水平为 $ 1-\alpha $ 的置信区间为 $ \left(\bar{X} \pm z_{\alpha / 2} \sigma / \sqrt{n}\right) .$\index{$\sigma^{2} $ 已知时 $ \mu $ 的置信区间}
\end{theorem}
\begin{theorem}[$\sigma^{2} $ 未知时 $ \mu $ 的置信区间]
    \index{$\sigma^{2} $ 未知时 $ \mu $ 的置信区间}
...
\begin{sidewaystable}[thp]
    ...
    \resizebox{.99\textwidth}{!}{
        \begin{tabular}{cccccc}
            ...
            \midrule
            \makecell[c]{$X\sim N\qty(\mu_1,\sigma_1^2)$                                                                        \\ $Y\sim N\qty(\mu_2,\sigma_2^2)$\\ $\sigma_1^2,\sigma_2^2$ 已知} & $\mu_1-\mu_2$ & \makecell[l]{$Z=\dfrac{\bar{X}-\bar{Y}-(\mu_1-\mu_2)}{\sqrt{\dfrac{\sigma_1^2}{n_1}+\dfrac{\sigma_2^2}{n_2}}}$\\$\sim N(0,1)$} & $\qty(\bar{X}-\bar{Y}\pm z_{\alpha/2}\sqrt{\dfrac{\sigma_1^2}{n_1}+\dfrac{\sigma_2^2}{n_2}})$ & \makecell[l]{$\left (-\infty, \bar{X}-\bar{Y}+z_{\alpha}\sqrt{\dfrac{\sigma_1^2}{n_1}+\dfrac{\sigma_2^2}{n_2}}\right )$} & \makecell[l]{$\left (\bar{X}-\bar{Y}-z_{\alpha}\sqrt{\dfrac{\sigma_1^2}{n_1}+\dfrac{\sigma_2^2}{n_2}},+\infty\right )$}\\
            \midrule
