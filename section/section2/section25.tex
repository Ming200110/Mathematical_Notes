...
\begin{theorem}[两点三次 Hermite 插值]
    ...
    \begin{flalign*}
        H_3(x) & =\qty(1+2\dfrac{x-x_k}{x_{k+1}-x_k})\qty(\dfrac{x-x_{k+1}}{x_k-x_{k+1}})^2y_k+\qty(1+2\dfrac{x-x_{k+1}}{x_k-x_{k+1}})\qty(\dfrac{x-x_k}{x_{k+1}-x_k})^2y_{k+1} \\
               ...
               &=\qty(1+\dfrac{2\Delta x_k}{\Delta x})\qty(\dfrac{\Delta x_{k+1}}{\Delta x})^2y_k+\qty(1+\dfrac{2\Delta x_{k+1}}{\Delta x})\qty(\dfrac{\Delta x_{k}}{\Delta x})^2y_{k+1}+\Delta x_k\qty(\dfrac{\Delta x_{k+1}}{\Delta x})^2m_k+\Delta x_{k+1}\qty(\dfrac{\Delta x_{k}}{\Delta x})^2m_{k+1}
    \end{flalign*}
