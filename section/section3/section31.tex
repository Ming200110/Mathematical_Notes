...
\begin{solution}\scriptsize\linespread{0.8}
    \begin{enumerate}[label=(\arabic{*})]
        ...
        \item 先将被积函数分解成部分分式之和, 可以证明:
              ...
              令 $ x \to a_{i}$, 由 L'Hospital 法则, 得
              $$1=\lim _{x \to a_{i}} \sum_{k=1}^{2 n} \dfrac{A_{k}\left(1+x^{2 n}\right)}{x-a_{k}}=\lim _{x \to a_{i}} \dfrac{A_{i}\left(1+x^{2 n}\right)}{x-a_{i}}=\lim _{x \to a_{i}}\left(2 n A_{i} x^{2 n-1}\right)=2 n A_{i} \dfrac{a_{i}^{2 n}}{a_{i}}=-\dfrac{2 n A_{i}}{a_{i}}$$
