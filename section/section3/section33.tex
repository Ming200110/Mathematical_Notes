...
\begin{definition}[无穷区间上的反常积分]
    设函数 $ f(x) $ 在 $ [a,+\infty) $ 上有定义, 在 $ [a, b]~(b<+\infty) $ 上可积, 若极限 $\displaystyle  \lim _{b \rightarrow+\infty} \int_{a}^{b} f(x) \dd  x $ 存在, 则定义
    $$\int_{0}^{+\infty} f(x) \dd  x=\lim _{b \rightarrow \infty} \int_{a}^{b} f(x) \dd  x$$
    ...
    类似地, 定义
    \begin{flalign*}
        \int_{-\infty}^{b} f(x) \dd  x       & =\lim _{a \rightarrow-\infty} \int_{a}^{b} f(x) \dd  x,                                                                                                                  \\
        \int_{-\infty}^{+\infty} f(x) \dd  x & =\int_{-\infty}^c f(x) \dd  x+\int_{c}^{+\infty} f(x) \dd  x=\lim _{a \rightarrow-\infty} \int_{a}^c f(x) \dd  x+\lim _{b \rightarrow+\infty} \int_{c}^{b} f(x) \dd  x .
    \end{flalign*}
\end{definition}

\begin{definition}[无界函数的反常积分 (瑕积分)]
    设函数 $ f(x) $ 在 $ [a, b) $ 上连续, 而且 $\displaystyle  \lim _{x \rightarrow b^{-}} f(x)=   \infty $, 若极限 $\displaystyle  \lim _{\varepsilon \rightarrow 0^{+}} \int_{a}^{b-\varepsilon} f(x) \dd  x $ 存在, 则定义
    $$\int_{a}^{b} f(x) \dd  x=\lim _{\varepsilon \rightarrow 0^{+}} \int_{a}^{b-\varepsilon} f(x) \dd  x$$
    并称 $\displaystyle  \int_{a}^{b} f(x) \dd  x $ 为 $ f(x) $ 在 $ [a, b) $ 上的反常积分, 这时也称反常积分 $\displaystyle  \int_{a}^{b} f(x) \dd  x $ 存在或收敛; 若上述极限不存在, 则称反常积分 $\displaystyle  \int_{a}^{b} f(x) \dd  x $ 不存在或发散.\\
                    类似地, 若 $ f(x) $ 在 $ (a, b] $ 上连续, $\displaystyle  \lim _{x \rightarrow a^{+}} f(x)=\infty $, 则定义
    $$\int_{a}^{b} f(x) \dd  x=\lim _{\varepsilon \rightarrow 0^{+}} \int_{a+\varepsilon}^{b} f(x) \dd  x$$
    若 $ f(x) $ 在 $ (a, b) $ 内连续, $\displaystyle  \lim _{x \rightarrow a^{+}} f(x)=\infty, \lim _{x \rightarrow b^{-}} f(x)=\infty $, 则定义
    $$\int_{a}^{b} f(x) \dd  x=\lim _{\varepsilon_{1} \rightarrow 0^{+}} \int_{a+\varepsilon_{1}}^{c} f(x) \dd  x+\lim _{\varepsilon_{2} \rightarrow 0^{+}} \int_{c}^{b-\varepsilon_2} f(x) \dd  x .$$
\end{definition}
...
\begin{theorem}[反常积分标准形敛散性判定]
    ...
    \begin{enumerate}[label=(\arabic{*})]
        \item 当 $ x \rightarrow 0 $ (瑕点), 当且仅当 $\alpha<1$ 或 $\begin{cases}
            \alpha=1\\ \beta>1
        \end{cases} $ 时收敛, 其余情况均发散;
        \item 当 $ x \rightarrow \infty $, 当且仅当 $ \alpha>1 $ 或 $\begin{cases}
            \alpha=1\\ \beta>1
        \end{cases} $ 时收敛, 其余情况均发散.
    \end{enumerate}
    \label{fcjfbzxing}
...
\end{example}
\begin{solution}
    $ \displaystyle \int_{1}^{+\infty} f(x) \dd x=\int_{1}^{\e } \dfrac{1}{(x-1)^{\alpha-1}} \dd +\int_{\e }^{+\infty} \dfrac{1}{x\ln^{\alpha+1}x} \dd x $, 当 $\alpha-1<1$, 即 $\alpha<2$ 时 $\displaystyle \int_{1}^{\e } \dfrac{1}{(x-1)^{\alpha-1}} \dd x$ 收敛, 
    $$
