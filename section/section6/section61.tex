...
\begin{proof}[{\songti \textbf{证}}]
    ...
    $$\frac{4\sqrt[3]{2}\pi}{3}=\sqrt[3]{2}\iiint\limits_\Omega\dd v\leqslant \iiint\limits_\Omega\sqrt[3]{x^2+2y-2z}\dd v\leqslant 2\iiint\limits_\Omega\dd v=\frac{8\pi}{3}.$$
\end{proof}
